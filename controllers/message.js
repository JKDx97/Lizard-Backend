...
const { userSocketMap } = require('../controllers/login'); // O donde exportes el map
...
exports.sendMessage = async (req, res) => {
  ...
  try {
    ...
    if (receiverSocketId) {
      ...
      console.log('Mensaje emitido a', receiverSocketId);
    } else {
      console.log('Usuario receptor no conectado');
    }
